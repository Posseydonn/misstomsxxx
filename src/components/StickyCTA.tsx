  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 flex flex-col gap-2 sm:gap-3">
      ...
      <a
        ...
        className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-accent flex items-center justify-center shadow-elevated glow-teal transition-transform duration-200 hover:scale-105"
      ...
      <a
        ...
        className="w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center shadow-elevated transition-transform duration-200 hover:scale-105"
      ...
      <Link
        to="/contacts"
        className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-primary flex items-center justify-center shadow-elevated glow-red transition-transform duration-200 hover:scale-105"
        aria-label="Записаться"
        title="Записаться на приём"
      >
        <span className="text-primary-foreground text-base sm:text-lg font-bold">→</span>
      </Link>
    </div>
  );
};
